...
var UsersService = function () {
    ...
    var UsersService = _classThis = /** @class */ (function () {
        ...
        UsersService_1.prototype.findAll = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.userModel.find().select('-password -refreshToken').exec()];
                });
            });
        };
        ...
        UsersService_1.prototype.remove = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.userModel.deleteOne({ _id: id }).exec()];
                        case 1:
                            result = _a.sent();
        ...
        UsersService_1.prototype.updateRefreshToken = function (id, refreshToken) {
            return __awaiter(this, void 0, void 0, function () {
        ...
        UsersService_1.prototype.clearRefreshToken = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.userModel
                                .updateOne({ _id: id }, { refreshToken: null })
                                .exec()];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
        ...
        UsersService_1.prototype.changePassword = function (id, oldPassword, newPassword) {
            return __awaiter(this, void 0, void 0, function () {
                var user, isPasswordValid, hashedNewPassword;
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        UsersService_1.prototype.updateProfilePicture = function (id, profilePicture) {
            return __awaiter(this, void 0, void 0, function () {
                var user;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.userModel
                                .findByIdAndUpdate(id, { profilePicture: profilePicture }, { new: true })
                                .select('-password -refreshToken')
                                .exec()];
                        case 1:
                            user = _a.sent();
        ...
        UsersService_1.prototype.getUsersByRole = function (role) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
        ...
        UsersService_1.prototype.searchUsers = function (query) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.userModel
                            .find({
        ...
        UsersService_1.prototype.getUsersStats = function () {
            return __awaiter(this, void 0, void 0, function () {
                var total, byRole, _a, _b, _c, today, activeToday;
                var _d;
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        ...
                        case 1:
                            total = _e.sent();
                            _d = {};
                            _a = user_schema_1.UserRole.USER;
                            return [4 /*yield*/, this.userModel.countDocuments({ role: user_schema_1.UserRole.USER })];
                        case 2:
                            _d[_a] = _e.sent();
                            _b = user_schema_1.UserRole.ADMIN;
                            return [4 /*yield*/, this.userModel.countDocuments({ role: user_schema_1.UserRole.ADMIN })];
                        case 3:
                            _d[_b] = _e.sent();
                            _c = user_schema_1.UserRole.MODERATOR;
                            return [4 /*yield*/, this.userModel.countDocuments({ role: user_schema_1.UserRole.MODERATOR })];
                        case 4:
                            byRole = (_d[_c] = _e.sent(),
                                _d);
                            today = new Date();
