...
var RateLimitMiddleware = function () {
    ...
    var RateLimitMiddleware = _classThis = /** @class */ (function () {
        function RateLimitMiddleware_1(configService) {
        ...
        RateLimitMiddleware_1.prototype.use = function (req, res, next) {
            return __awaiter(this, void 0, void 0, function () {
                var clientIp, endpoint, method, limits, limit, key, current, ttl, error_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            key = "rate-limit:".concat(clientIp, ":").concat(endpoint, ":").concat(method);
                            _a.label = 1;
                        case 1:
                            _a.trys.push([1, 6, , 7]);
                        ...
                        case 2:
                            current = _a.sent();
                            if (!(current === 1)) return [3 /*break*/, 4];
                            return [4 /*yield*/, this.redis.expire(key, limit.window)];
                        case 3:
                            _a.sent();
                            _a.label = 4;
                        case 4: return [4 /*yield*/, this.redis.ttl(key)];
                        case 5:
                            ttl = _a.sent();
