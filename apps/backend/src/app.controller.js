...
var AppController = function () {
    ...
    (function () {
        ...
        _getInfo_decorators = [(0, public_decorator_1.Public)(), (0, common_1.Get)(), (0, swagger_1.ApiOperation)({ summary: 'Get API information' }), (0, swagger_1.ApiResponse)({ status: 200, description: 'API information' }), openapi.ApiResponse({ status: 200, type: Object })];
        _healthCheck_decorators = [(0, public_decorator_1.Public)(), (0, common_1.Get)('health'), (0, swagger_1.ApiOperation)({ summary: 'Health check endpoint' }), (0, swagger_1.ApiResponse)({ status: 200, description: 'Service is healthy' }), openapi.ApiResponse({ status: 200, type: Object })];
